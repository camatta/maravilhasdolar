...
const faqData = [
  {
    ...
    answer:
      'As formas de pagamento disponíveis na maravilhasdolar.com são Cartão de crédito, Cartão Maravilhas do Lar e PIX. O parcelamento pode ser feito via pagamento com cartão de crédito em até 10x, ou pelo cartão Maravilhas do Lar em até 15x fixas. O valor mínimo das parcelas e a quantidade de parcelas sem juros podem variar de acordo com as campanhas ativas. Confira sempre nossa Política de Compra.',
    category: 'Online',
  },
  {
    question: 'Posso alterar a forma de pagamento de um pedido realizado?',
    answer:
      'Não. Após a finalização de um pedido não é possível alterar a forma de pagamento. Um novo pedido deve ser realizado.',
    category: 'Online',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Temos um canal exclusivo para Pessoa Jurídica através do link https://www.maravilhasdolar.com/empresas. Porém só entregamos os pedidos para o Estado de SP. Para compra faturada em Loja Física, você deve entrar em contato através do e-mail: vendas@maravilhasdolar.com.br ou através do WhatsApp (11) 93236-1811.',
    category: 'Online',
  },
  {
    question: 'Como acompanhar o andamento do meu pedido?',
    answer:
      'Para acompanhar o andamento do seu pedido, basta acessar sua conta com login e senha em Minha Conta, em seguida clique em Meus Pedidos e em VER DETALHES do pedido. Ou acesse o link: https://www.maravilhasdolar.com/rastreio.',
    category: 'Online',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Telefone 4000-1567 - Segunda a sábado das 8h às 18h, exceto em feriados. E-mail: sac@maravilhasdolar.com.br Chat - Segunda à quinta das 9h às 18h e Sexta das 9h às 17h.',
    category: 'Online',
  },
  {
    question: 'Esqueci de adicionar um produto no meu pedido. O que fazer?',
    answer:
      'Entre em contato imediatamente com a nossa equipe via e-mail sac@maravilhasdolar.com.br ou telefone (11) 4000-1567. O pedido deverá ser cancelado e você realizará um novo pedido, pois não é possível adicionar produtos após a finalização de um pedido.',
    category: 'Online',
  },
  {
    question: 'Não recebi todos os produtos do meu pedido.',
    answer:
      'Os pedidos podem ser entregues em entregas diferentes, portanto é normal não receber todos os produtos de uma vez. Se mesmo assim você receber todos os pacotes e está faltando produtos, favor entrar em contato por e-mail sac@maravilhasdolar.com.br que verificaremos o ocorrido.',
    category: 'Online',
  },
  {
    question: 'Posso comprar no site e retirar na loja física?',
    answer:
      'Sim! Na finalização da sua compra você pode escolher a opção de entrega Retirada na Loja. Ao selecionar essa opção, abrirá uma lista com as lojas para que você possa selecionar a loja para retirada do seu pedido.',
    category: 'Online',
  },
  {
    question: 'Qual o Prazo de Entrega para Retirada na Loja?',
    answer:
      'Após a aprovação de pagamento do seu pedido, a loja tem até 1 dia útil para separar o seu pedido e deixar prontinho para você retirar. Você receberá um e-mail quando estiver pronto.',
    category: 'Online',
  },
  {
    question: 'A loja física que quero retirar meu pedido está indisponível. O que significa?',
    answer:
      'Significa que um dos itens do seu carrinho não está disponível em estoque na loja selecionada. Por isso não será possível seguir com a loja selecionada. Escolha outra forma de entrega, ou entre em contato com a nossa equipe de atendimento.',
    category: 'Online',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Para rastrear a entrega do seu pedido, acesse o link: https://www.maravilhasdolar.com/rastreio. Caso não tenha informações sobre seu pedido, é porque ainda não está com a transportadora e está no prazo de separação.',
    category: 'Online',
  },
  {
    question: 'Gostaria de comprar via boleto, é possível?',
    answer:
      'Por tempo indeterminado, não estamos aceitando Boleto como opção de pagamento. Experimente as vantagens de comprar em PIX.',
    category: 'Online',
  },
  {
    question: 'Quero cancelar uma compra que ainda não foi aprovada, o que devo fazer?',
    answer:
      'Se a compra foi no PIX e você não realizou o pagamento, será cancelado automaticamente. Porém, se for com cartão ou PIX já pago, entre em contato pelos canais de atendimento: E-mail: sac@maravilhasdolar.com.br, chat ou telefone (11) 4000-1567.',
    category: 'Trocas',
  },
  {
    question: 'Como trocar ou devolver um produto?',
    answer:
      "Você tem até 7 dias corridos após a entrega para solicitar a troca ou devolução. Para isso, acesse sua conta em Meus Pedidos, clique em VER DETALHES e em 'Solicitar troca ou devolução'. Escolha o produto, informe o motivo e opte pelo estorno ou recebimento de outro item. Nossa equipe responderá em até 3 dias úteis e enviará um código de autorização de postagem nos Correios. O produto deve estar completo, sem sinais de mau uso, na embalagem original e em perfeito estado. A análise técnica será feita em até 7 dias úteis após o recebimento. Caso os requisitos não sejam atendidos, a devolução não será aceita e o item será enviado de volta sem restituição de valores.",
    category: 'Trocas',
  },
  {
    question: 'Recebi um produto quebrado. O que fazer?',
    answer:
      'Infelizmente, isso pode acontecer. Envie fotos do item quebrado e da embalagem recebida para sac@maravilhasdolar.com.br. Após análise, providenciaremos o envio de um novo item ou realizaremos o estorno. Caso prefira a substituição, enviaremos um novo produto igual ao adquirido.',
    category: 'Trocas',
  },
  {
    question: 'Como funciona a Lista de Presentes?',
    answer:
      'A lista de presentes da Maravilhas do Lar é feita diretamente no site, permitindo que você escolha entre receber os presentes em créditos para usar no site ou receber os produtos escolhidos no seu endereço. A lista funciona 100% online, sem possibilidade de criação ou troca em lojas físicas. Após finalizada, não é possível alterar a forma de recebimento.',
    category: 'Presentes',
  },
  {
    question: 'Como criar uma Lista de Presentes?',
    answer:
      'Para criar sua lista de presentes, acesse https://www.maravilhasdolar.com/listas-de-presentes e escolha o tipo de lista desejado. Depois, adicione os produtos e compartilhe o link com seus amigos e familiares para que possam comprar.',
    category: 'Presentes',
  },
  {
    question: 'Meus convidados podem comprar nas Lojas Físicas?',
    answer:
      'Não, os convidados só terão acesso à sua lista diretamente pelo site, não sendo possível a compra na loja física.',
    category: 'Presentes',
  },
  {
    question: 'Compra no site com retirada na Loja Física. Como funciona?',
    answer:
      'Se um convidado escolher a opção de retirada na loja, ele será responsável por buscar o produto na loja selecionada e entregá-lo ao dono da lista. Ele também pode informar o anfitrião como contato para retirada e notificá-lo sobre a loja escolhida.',
    category: 'Presentes',
  },
  {
    question: 'Qual o prazo de troca da lista de presentes?',
    answer:
      'Caso tenha selecionado a opção de crédito, os vales-compras recebidos terão validade de 90 dias.',
    category: 'Presentes',
  },
  {
    question: 'Onde posso encontrar os termos de uso da lista de presentes?',
    answer:
      'Você pode acessar os termos de uso completos em: https://www.maravilhasdolar.com/conteudo/politicas-e-termos/termos-lista-de-presentes.',
    category: 'Presentes',
  },
  {
    question: 'Qual o horário de funcionamento das lojas?',
    answer:
      'Para conferir o horário de atendimento das nossas lojas acesse o link: https://www.maravilhasdolar.com/nossas-lojas',
    category: 'Lojas',
  },
  {
    question: 'Em qual cidade tem loja da Maravilhas do Lar?',
    answer:
      'A Maravilhas do Lar está presente em 25 cidades do interior de São Paulo com mais de 40 lojas. Para saber todos os endereços e horários de funcionamento acesse o link: https://www.maravilhasdolar.com/nossas-lojas',
    category: 'Lojas',
  },
  {
    question: 'Quais as formas de pagamento nas lojas?',
    answer:
      'Nas lojas físicas o pagamento pode ser realizado através do cartão de crédito ou débito, cartão Maravilhas do Lar, dinheiro e, também por Pix pelo QR Code.',
    category: 'Lojas',
  },
  {
    question: 'Posso levar meu pet nas lojas?',
    answer:
      'Seu pet é muito bem-vindo em nossas lojas, lembrando que durante as compras o seu amiguinho deve permanecer a todo momento no colo ou no carrinho.',
    category: 'Lojas',
  },
  {
    question: 'As lojas possuem acessibilidade para deficientes físicos?',
    answer:
      'As lojas Maravilhas do Lar contam com espaços acessíveis a pessoas com dificuldade de locomoção assim como a disponibilização de cadeiras de rodas em todas as unidades.',
    category: 'Lojas',
  },
  {
    question: 'Qual o telefone de contato para falar nas lojas?',
    answer:
      'Não temos um número para contato com as lojas, você pode utilizar o telefone (11) 4000 1567 do atendimento ao cliente e vamos te ajudar da melhor forma possível.',
    category: 'Lojas',
  },
  {
    question: 'Quero fazer uma reclamação',
    answer:
      'Sua reclamação pode ser encaminhada por e-mail no sac@maravilhasdolar.com.br vamos te ajudar a solucionar seu problema.',
    category: 'Lojas',
  },
  {
    question: 'Como trocar um produto comprado na loja física?',
    answer:
      'Você precisa ir até a loja onde foi efetuado a compra com o produto e o cupom fiscal em mãos em um prazo de 7 dias corridos. A troca deve ocorrer exclusivamente na mesma loja de compra.',
    category: 'Lojas',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Envie o seu currículo para o e-mail recrutamento.lojas@maravilhasdolar.com.br, no assunto informe a Cidade de interesse. O currículo deve ser enviado como anexo.',
    category: 'Outros',
  },
  {
    question: 'Quero fazer parceria de Marketing',
    answer:
      'Para parcerias e oferecimento de mídia você pode encaminhar um e-mail para marketing@maravilhasdolar.com.br',
    category: 'Outros',
  },
  {
    question: 'Quero ser fornecedor de produtos',
    answer:
      'Cadastre sua empresa para ser fornecedor da Maravilhas do Lar, clicando aqui',
    category: 'Outros',
  },
  {
    question: 'Quero apresentar imóvel para abrir uma unidade Maravilhas do Lar',
    answer:
      'Você pode encaminhar um e-mail para sac@maravilhasdolar.com.br vamos direcionar para o responsável pela expansão da Maravilhas do Lar.',
    category: 'Outros',
  },
  {
    question: 'Quero abrir uma franquia da Maravilhas do Lar na minha cidade',
    answer:
      'A Maravilhas do Lar não é uma franquia. Somos uma rede de lojas de Utilidades para o lar.',
    category: 'Outros',
  },
  {
    question: 'Gostaria de um orçamento para venda Faturada (B2B)',
    answer:
      'Você pode encaminhar um e-mail para vendas@maravilhasdolar.com.br vamos te ajudar a efetuar sua compra com CNPJ.',
    category: 'Outros',
  },
  {
    question: 'A Maravilhas do Lar tem vale presente?',
    answer:
      'Não, temos disponível apenas a opção de lista de presente, com conversão em crédito, no site.',
    category: 'Outros',
  },
  {
    question: 'A Maravilhas do Lar vende por atacado?',
    answer:
      'Temos preços competitivos com relação ao mercado, por isso não atuamos com o fornecimento de produtos por atacado.',
    category: 'Outros',
  },
  {
    question: 'Como solicitar meu Cartão Maravilhas do Lar?',
    answer:
      'Solicite o seu Cartão Maravilhas do Lar em uma de nossas lojas ou pelo APP.\n\nLojas Físicas:\nBasta comparecer a uma de nossas lojas, no balcão de atendimento, com seus documentos pessoais (RG e CPF) e Celular, e não possuir restrições de crédito.\n\nObs1: O crédito está sujeito à aprovação.\nObs2: A idade mínima é de 18 anos.\n\nAplicativo:\nSolicite o seu cartão agora mesmo! Clique aqui, e baixe o app. https://play.google.com/store/apps/details?id=br.com.portaldocartao.cartaomaravilhasdolar',
    category: 'Cartao',
  },
  {
    question: 'Como desbloquear meu Cartão Maravilhas do Lar?',
    answer:
      'Para desbloquear o cartão, entre em contato com a central de Relacionamento Credsystem, nos telefones 4003-3900 para capitais e regiões metropolitanas ou 0800 729 3900 para demais localidades, somente para chamadas de telefone fixo, de segunda a sábado, das 8h às 22h, ou domingos e feriados das 9h às 20h. WhatsApp https://api.whatsapp.com/send?phone=551140033900 ou e-mail: atendimento@credsystem.com.br. Você pode também solicitar o desbloqueio na loja de emissão ou pelo site: https://www.portaldocartao.com.br/\n\nOs cartões emitidos nas lojas desbloqueiam nos caixas assim que efetuar a primeira compra.',
    category: 'Cartao',
  },
  {
    question: 'Em quantas vezes posso dividir minha compra com o Cartão Maravilhas do Lar?',
    answer:
      'Disponibilizamos o parcelamento de compras em até 10x* sem juros. Condições sujeitas a alteração e sem prévio aviso. Ou em até 15x* com juros.\n\n*Consulte tabela de informações do Cartão.',
    category: 'Cartao',
  },
  {
    question: 'Como tenho acesso a minha fatura e como posso pagar?',
    answer:
      'Referente às faturas mensais, a Credsystem não encaminha fatura física aos clientes. No portal www.portaldocartao.com.br/, acessando com CPF + data de nascimento, você pode aderir à fatura digital e recebê-la no celular (SMS) e/ou e-mail. Também disponibilizamos por WhatsApp através da Cléo 11 40033900, App Cartão Maravilhas do Lar ou em uma de nossas lojas. Os pagamentos podem ser realizados em qualquer agência bancária, internet banking, lotérica (quando houver boleto) ou em uma de nossas lojas (em dinheiro).',
    category: 'Cartao',
  },
  {
    question: 'Como solicitar cartão adicional?',
    answer:
      'Durante a solicitação do cartão (loja física ou App), o titular tem a possibilidade de incluir até 2 cartões adicionais. Após concluída a emissão, só é possível adicionar solicitando pela Central da Credsystem.\n\nObs1: As compras serão feitas por cartão digital, para o adicional não é gerado cartão físico.\nObs2: Os adicionais precisam ser maiores de 18 anos e passarão por análise de crédito.',
    category: 'Cartao',
  },
  {
    question: 'Como funciona a anuidade do meu Cartão Maravilhas do Lar?',
    answer:
      'A anuidade diferenciada ("AD") é cobrada mensalmente, sempre que houver movimentação na conta do cliente, pela disponibilização e utilização do cartão na rede de estabelecimentos afiliados.\n\n("AD") R$ 5,99*\n\n**Será concedido o desconto de R$1,00 na Anuidade Diferenciada apenas aos clientes que efetuarem o pagamento em loja.',
    category: 'Cartao',
  },
  {
    question: 'Em quais lugares posso comprar com o meu cartão Maravilhas do Lar?',
    answer:
      'Você poderá utilizar o seu Cartão Maravilhas em qualquer uma de nossas lojas físicas ou em nosso e-commerce.',
    category: 'Cartao',
  },
  {
    question: 'Esqueci minha senha do Cartão Maravilhas do Lar, o que devo fazer?',
    answer:
      'Consulte nossa Central de Relacionamento Cred-System: Grande São Paulo: 4003 39 00 / Demais Localidades: 0800 729 3900.',
    category: 'Cartao',
  },
  {
    question: 'Como comunicar perda ou roubo do Cartão Maravilhas do Lar?',
    answer:
      'Para comunicar perda ou roubo do seu cartão você deverá entrar em contato com a nossa Central de Relacionamento Cred-System: Grande São Paulo: 4003 39 00 / Demais Localidades: 0800 729 3900.',
    category: 'Cartao',
  },
]

const exchangeIcon = `<svg width="93" height="92" viewBox="0 0 93 92" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const bagIcon = `<svg width="97" height="96" viewBox="0 0 97 96" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const cardIcon = `<svg width="97" height="96" viewBox="0 0 97 96" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M84.2 21H13.8C11.1536 21 9 23.1536 9 25.8V70.6C9 73.2464 11.1536 75.4 13.8 75.4H84.2C86.8464 75.4 89 73.2464 89 70.6V25.8C89 23.1536 86.8464 21 84.2 21ZM85.8 70.6C85.8 71.48 85.08 72.2 84.2 72.2H13.8C12.9169 72.2 12.2 71.48 12.2 70.6V25.8C12.2 24.9167 12.9169 24.2 13.8 24.2H84.2C85.08 24.2 85.8 24.9167 85.8 25.8V70.6Z" fill="#1C1C1C"></path><path d="M87.4016 35.4H10.6016V41.8H87.4016V35.4Z" fill="#1C1C1C"></path><path d="M87.4 33.8H10.6C9.71687 33.8 9 34.5167 9 35.4V41.8C9 42.6833 9.71687 43.4 10.6 43.4H87.4C88.2831 43.4 89 42.6833 89 41.8V35.4C89 34.5167 88.2831 33.8 87.4 33.8ZM85.8 40.2H12.2V37H85.8V40.2Z" fill="#1C1C1C"></path><path d="M52.2008 53H23.4008C22.5177 53 21.8008 53.7169 21.8008 54.6C21.8008 55.4831 22.5177 56.2 23.4008 56.2H52.2008C53.0839 56.2 53.8008 55.4831 53.8008 54.6C53.8008 53.7167 53.0839 53 52.2008 53Z" fill="#1C1C1C"></path><path d="M39.4008 59.4001H23.4008C22.5177 59.4001 21.8008 60.117 21.8008 61.0001C21.8008 61.8832 22.5177 62.6001 23.4008 62.6001H39.4008C40.2839 62.6001 41.0008 61.8832 41.0008 61.0001C41.0008 60.117 40.2839 59.4001 39.4008 59.4001Z" fill="#1C1C1C"></path></svg>`
const sidebarCardCategoryIcon = `<svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M50.76 8.64001H3.24C1.45368 8.64001 0 10.0937 0 11.88V42.12C0 43.9063 1.45368 45.36 3.24 45.36H50.76C52.5463 45.36 54 43.9063 54 42.12V11.88C54 10.0937 52.5463 8.64001 50.76 8.64001ZM51.84 42.12C51.84 42.714 51.354 43.2 50.76 43.2H3.24C2.64389 43.2 2.16 42.714 2.16 42.12V11.88C2.16 11.2838 2.64389 10.8 3.24 10.8H50.76C51.354 10.8 51.84 11.2838 51.84 11.88V42.12Z" fill="white"></path><path d="M52.9181 18.36H1.07812V22.68H52.9181V18.36Z" fill="white"></path><path d="M52.92 17.28H1.08C0.483891 17.28 0 17.7638 0 18.36V22.68C0 23.2762 0.483891 23.76 1.08 23.76H52.92C53.5161 23.76 54 23.2762 54 22.68V18.36C54 17.7638 53.5161 17.28 52.92 17.28ZM51.84 21.6H2.16V19.44H51.84V21.6Z" fill="white"></path><path d="M29.1606 30.24H9.72063C9.12452 30.24 8.64062 30.7239 8.64062 31.32C8.64062 31.9161 9.12452 32.4 9.72063 32.4H29.1606C29.7567 32.4 30.2406 31.9161 30.2406 31.32C30.2406 30.7238 29.7567 30.24 29.1606 30.24Z" fill="white"></path><path d="M20.5206 34.5601H9.72063C9.12452 34.5601 8.64062 35.044 8.64062 35.6401C8.64062 36.2362 9.12452 36.7201 9.72063 36.7201H20.5206C21.1167 36.7201 21.6006 36.2362 21.6006 35.6401C21.6006 35.044 21.1167 34.5601 20.5206 34.5601Z" fill="white"></path></svg>`
const userIcon = `<svg width="93" height="92" viewBox="0 0 93 92" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const cartCategoryIcon = `<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const boxCategoryIcon = `<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const giftCategoryIcon = `<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const storeCategoryIcon = `<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const otherCategoryIcon = `<svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const defaultFeaturedCards = [
  {
    ...
    iconSvg: exchangeIcon,
    links: [
      { label: 'Acompanhar troca', url: '/troca' },
      { label: 'Autorização de postagem', url: '/troca' },
      { label: 'Solicitar troca ou devolução', url: '/troca' },
    ],
  },
  {
    title: 'Meus Pedidos',
    iconSvg: bagIcon,
    links: [
      { label: 'Acompanhar entrega', url: '/troca' },
      { label: 'Imprimir boleto', url: '/troca' },
      { label: 'Cancelar pedido ou entrega', url: '/troca' },
    ],
  },
  {
    title: 'Cartão Maravilhas',
    iconSvg: cardIcon,
    links: [
      { label: 'Acesse sua fatura', url: '/troca' },
      { label: 'Termos e condições de uso', url: '/troca' },
      { label: 'Solicite seu cartão', url: '/troca' },
      { label: 'Detalhamento Contrato', url: '/troca' },
    ],
  },
  {
    title: 'Meus Dados',
    iconSvg: userIcon,
    links: [
      { label: 'Informações pessoais', url: '/troca' },
      { label: 'Senha e e-mail', url: '/troca' },
      { label: 'Meus telefones', url: '/troca' },
      { label: 'Endereços', url: '/troca' },
    ],
  },
]

const defaultCategories = [
  { value: 'Online', label: 'Loja Online', iconSvg: cartCategoryIcon },
  { value: 'Trocas', label: 'Trocas e Cancelamentos', iconSvg: boxCategoryIcon },
  { value: 'Presentes', label: 'Lista de Presentes', iconSvg: giftCategoryIcon },
  { value: 'Lojas', label: 'Lojas Físicas', iconSvg: storeCategoryIcon },
  { value: 'Outros', label: 'Outros Assuntos', iconSvg: otherCategoryIcon },
  { value: 'Cartao', label: 'Cartão Maravilhas do Lar', iconSvg: sidebarCardCategoryIcon },
]
...
const sanitizeFaqItems = (items) => {
  ...
  return items.filter((item) => item && item.question && item.answer)
}

const sanitizeFeaturedCards = (cards) => {
  if (!Array.isArray(cards) || !cards.length) {
    return defaultFeaturedCards
  }
  ...
  return cards
    ...
    .map((card) => ({
      ...
      links: Array.isArray(card.links)
        ? card.links.filter((link) => link && link.label && link.url)
        : [],
    }))
}

const sanitizeCategories = (categories, items) => {
  ...
  const existingValues = new Set(baseCategories.map((category) => category.value))
...
const FAQ = ({
  pageTitle = 'FAQ',
  helperTitle = 'Insira sua pergunta no campo abaixo',
  searchPlaceholder = 'Procure por um termo específico...',
  searchResultLabel = 'Resultados para:',
  listTitle = 'Perguntas Frequentes',
  noResultsText = 'Nenhuma pergunta encontrada.',
  ...
  const safeFaqItems = sanitizeFaqItems(faqItems)
  const safeFeaturedCards = sanitizeFeaturedCards(featuredCards)
  const safeCategories = sanitizeCategories(categories, safeFaqItems)
  const normalizedSearch = searchTerm.toLowerCase()

  const filteredQuestions = safeFaqItems.filter((faq) => {
    const matchesSearch =
    ...
    <div className={styles.wrapperFaq}>
      <div className={styles.containerFaq}>
        <div className={styles.faqHeader}>
          <h1 className={styles.faqTitle}>{pageTitle}</h1>
        </div>

        <div className={styles.wrapperCardsFaq}>
          {safeFeaturedCards.map((card, cardIndex) => (
            <div key={`${card.title}-${cardIndex}`} className={styles.cardFaq}>
              <div className={styles.topoCardFaq}>
                {card.iconSvg ? (
                  <div
                    className={styles.iconCardFaq}
          ...
          <div className={styles.faqMainContent}>
            <div className={styles.sidebarMainFaq}>
              {safeCategories.map((category, index) => (
                <div key={`${category.value}-${index}`} className={styles.cardSidebarFaq}>
                  <div
                  ...
                  >
                    {category.iconSvg ? (
                      <div
                        className={styles.iconCardSidebar}
...
FAQ.schema = {
  ...
  properties: {
    ...
    helperTitle: {
      title: 'Texto acima da busca',
      type: 'string',
      default: 'Insira sua pergunta no campo abaixo',
    },
    searchPlaceholder: {
      title: 'Placeholder da busca',
      type: 'string',
      default: 'Procure por um termo específico...',
    },
    searchResultLabel: {
      title: 'Texto do resultado da busca',
      type: 'string',
    ...
    noResultsText: {
      title: 'Texto sem resultados',
      type: 'string',
      default: 'Nenhuma pergunta encontrada.',
    },
    featuredCards: {
      title: 'Cards de destaque',
      type: 'array',
      default: defaultFeaturedCards,
      items: {
        type: 'object',
        properties: {
          title: {
      ...
      items: {
        ...
        properties: {
          ...
          value: {
            title: 'Identificador',
            type: 'string',
            description: 'Use este mesmo valor nas perguntas.',
          },
          iconSvg: {
            title: 'SVG do ícone',
            type: 'string',

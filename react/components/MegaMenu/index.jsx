...
const MegaMenu = ({
  ...
  const desktopClasses = classNames(styles.container)

  return (
    <nav className={desktopClasses}>
      <Container className={`${styles['section--department']}`}>
        <ul
...
export default compose(graphql(getCategories), injectIntl)(MegaMenu)
